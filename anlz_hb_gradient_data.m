...
% Levine Lab                                    Last Modified: 03/28/11
  ...
  %% New data-method
  clear all;
    rawfolder = '/Volumes/Data/Lab Data/Raw_Data/02-17-11/MP09_22C/'; %'/Volumes/Data/Lab Data/Raw_Data/02-17-11/MP01_22C/'; %  '/Volumes/Data/Lab Data/Raw_Data/02-17-11/MP09_22C/'; %
  folder = '/Users/alistair/Documents/Berkeley/Levine_Lab/Projects/Enhancer_Modeling/Data/'; 
   fname = 'MP09_22C_hb_y_f'; Es = 7; % 'MP02_22C_hb_y_b'; Es = 10; % 'MP01_22C_hb_y_f'; Es = 12; %  'MP01_22C_hb_y_c'; Es = 4; %  'MP09_22C_hb_y_e'; Es =12; % 'MP09_22C_hb_y_d'; Es =12; % 'MP01_22C_hb_y'; Es = 13; % 
...
hold on; plot(x,sqrt(mu(:,2))./mu(:,2),'k.','MarkerSize',10);
ylabel('CoV'); xlabel('distance (\mum)');
legend('Actual CoV','Poisson CoV');
  title(['Nuclei = ',num2str(Nnucs)]);
