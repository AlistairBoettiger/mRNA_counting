...
% rawfolder = '/Volumes/Data/Lab Data/Raw_Data/02-17-11/YW_ths_sog/'; fname = 'YW_ths_sog';
folder = '/Users/alistair/Documents/Berkeley/Levine_Lab/Projects/Enhancer_Modeling/Data/'; 


% rawfolder = '/Volumes/Data/Lab Data/Raw_Data/02-17-11/MP09_22C/'; fname = 'MP09_22C_hb_y_d'; 
rawfolder = '/Volumes/Data/Lab Data/Raw_Data/02-17-11/MP01_22C/'; fname = 'MP01_22C_hb_y'; 
  ...
  %% 
    ...
    for e=1:10
        figure(1); subplot(6,2,e); 
         ...
         hold on; hist(ons{e,1}); % xlim([0,max(x)]);
         title(['y=',num2str(mean(ons{e,2}),3),...
             ' (',num2str(std(ons{e,2}),3) ')  hb=',num2str(mean(ons{e,1}),3),...
    ...
    for e=1:10
        figure(2); subplot(6,2,e); 
         hist(offs{e,2},x);
         set(findobj(gca,'Type','patch'),'FaceColor','y');
         hold on; hist(offs{e,1},x); xlim([0,max(x)]);
         title(['y=',num2str(mean(offs{e,2}),3),...
             ' (',num2str(std(offs{e,2}),3) ')  hb=',num2str(mean(offs{e,1}),3),...
